...
public class TOMMY_SQLLexer extends Lexer {
    ...
    public final void mWS() throws RecognitionException {
        try {
            int _type = WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // org/tommy/stationery/ink/core/TOMMY_SQL.g:538:4: ( ( WHITESPACE )+ )
            // org/tommy/stationery/ink/core/TOMMY_SQL.g:538:6: ( WHITESPACE )+
            {
            // org/tommy/stationery/ink/core/TOMMY_SQL.g:538:6: ( WHITESPACE )+
            int cnt1=0;
            loop1:
    ...
    public final void mNAME() throws RecognitionException {
        try {
            int _type = NAME;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // org/tommy/stationery/ink/core/TOMMY_SQL.g:539:6: ( ( DIV | UNICODE_LETTER | UNICODE_DIGIT | LETTER | DIGIT | LSQUARE | RSQUARE | ANDMARK | COLON | COMM | UNDERLINE | MINUS | LBLE | RBLE | QUESTION | EXCLAMATION ) ( DIV | UNICODE_LETTER | UNICODE_DIGIT | LETTER | DIGIT | LSQUARE | RSQUARE | ANDMARK | COLON | COMM | UNDERLINE | MINUS | LBLE | RBLE | QUESTION | EXCLAMATION )* )
            // org/tommy/stationery/ink/core/TOMMY_SQL.g:539:8: ( DIV | UNICODE_LETTER | UNICODE_DIGIT | LETTER | DIGIT | LSQUARE | RSQUARE | ANDMARK | COLON | COMM | UNDERLINE | MINUS | LBLE | RBLE | QUESTION | EXCLAMATION ) ( DIV | UNICODE_LETTER | UNICODE_DIGIT | LETTER | DIGIT | LSQUARE | RSQUARE | ANDMARK | COLON | COMM | UNDERLINE | MINUS | LBLE | RBLE | QUESTION | EXCLAMATION )*
            {
            ...
            // org/tommy/stationery/ink/core/TOMMY_SQL.g:539:138: ( DIV | UNICODE_LETTER | UNICODE_DIGIT | LETTER | DIGIT | LSQUARE | RSQUARE | ANDMARK | COLON | COMM | UNDERLINE | MINUS | LBLE | RBLE | QUESTION | EXCLAMATION )*
            loop2:
            do {
                int alt2=2;
    ...
    public final void mWHITESPACE() throws RecognitionException {
        try {
            // org/tommy/stationery/ink/core/TOMMY_SQL.g:541:21: ( ( '\\t' | '\\r' | '\\n' | ' ' | '\\u000C' ) )
            // org/tommy/stationery/ink/core/TOMMY_SQL.g:541:23: ( '\\t' | '\\r' | '\\n' | ' ' | '\\u000C' )
            {
    ...
    public final void mLETTER() throws RecognitionException {
        try {
            // org/tommy/stationery/ink/core/TOMMY_SQL.g:542:17: ( ( 'a' .. 'z' | 'A' .. 'Z' ) )
            // org/tommy/stationery/ink/core/TOMMY_SQL.g:542:19: ( 'a' .. 'z' | 'A' .. 'Z' )
            {
    ...
    public final void mDIGIT() throws RecognitionException {
        try {
            // org/tommy/stationery/ink/core/TOMMY_SQL.g:543:16: ( '0' .. '9' )
            // org/tommy/stationery/ink/core/TOMMY_SQL.g:543:18: '0' .. '9'
            {
            matchRange('0','9'); 
    ...
    public final void mUNICODE_DIGIT() throws RecognitionException {
        try {
            // org/tommy/stationery/ink/core/TOMMY_SQL.g:809:2: ( '\\u0030' .. '\\u0039' | '\\u0660' .. '\\u0669' | '\\u06F0' .. '\\u06F9' | '\\u0966' .. '\\u096F' | '\\u09E6' .. '\\u09EF' | '\\u0A66' .. '\\u0A6F' | '\\u0AE6' .. '\\u0AEF' | '\\u0B66' .. '\\u0B6F' | '\\u0BE7' .. '\\u0BEF' | '\\u0C66' .. '\\u0C6F' | '\\u0CE6' .. '\\u0CEF' | '\\u0D66' .. '\\u0D6F' | '\\u0E50' .. '\\u0E59' | '\\u0ED0' .. '\\u0ED9' | '\\u0F20' .. '\\u0F29' | '\\u1040' .. '\\u1049' | '\\u1369' .. '\\u1371' | '\\u17E0' .. '\\u17E9' | '\\u1810' .. '\\u1819' | '\\uFF10' .. '\\uFF19' )
            // org/tommy/stationery/ink/core/TOMMY_SQL.g:
            {
