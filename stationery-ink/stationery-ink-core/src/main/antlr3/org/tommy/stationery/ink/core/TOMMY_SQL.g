...
source_meta_name returns [String ret]
    :   n=('CATALOG'|'URL'|'DRIVER'|'ID'|'PW'|'VHOST'|'PORT') { $ret = n.getText(); }
    ;
...
NAME : (UNICODE_LETTER|UNICODE_DIGIT|LETTER|DIGIT|LSQUARE|RSQUARE|ANDMARK|COLON|COMM|UNDERLINE|MINUS|LBLE|RBLE|QUESTION|EXCLAMATION) (UNICODE_LETTER|UNICODE_DIGIT|LETTER|DIGIT|LSQUARE|RSQUARE|ANDMARK|COLON|COMM|UNDERLINE|MINUS|LBLE|RBLE|QUESTION|EXCLAMATION)*;
