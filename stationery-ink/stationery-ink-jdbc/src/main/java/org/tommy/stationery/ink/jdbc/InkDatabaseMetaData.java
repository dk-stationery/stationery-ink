...
/**
 * Created by kun7788 on 15. 2. 23..
 */
public class InkDatabaseMetaData implements DatabaseMetaData {

    private static final Logger logger = LoggerFactory.getLogger(InkDatabaseMetaData.class);

    private InkConnection connection;

    public InkDatabaseMetaData(InkConnection connection) throws SQLException {
    ...
    public String getURL() throws SQLException {
        return connection.getInkRestClient().getUrl();
    }
    ...
    public InkResultSet getPseudoColumns(String catalog, String schemaPattern, String tableNamePattern,
